...
function M.json.load()
  local path = vim.fn.stdpath("config") .. "/myvim.json"
...
function M.load(name)
  ...
  -- always load myvim, then user file
...
function M.init()
  ...
  M.did_init = true
  local plugin = require("lazy.core.config").spec.plugins.MyVim
  if plugin then
    vim.opt.rtp:append(plugin.dir)
  end

  package.preload["myvim.plugins.lsp.format"] = function()
    Util.deprecate([[require("myvim.plugins.lsp.format")]], [[require("myvim.util").format]])
    return Util.format
  end

  -- delay notifications till vim.notify was replaced or after 500ms
  require("myvim.util").lazy_notify()
