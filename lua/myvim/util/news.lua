...
function M.welcome()
  Util.info("Welcome to MyVim!")
end

function M.changelog()
  M.open("CHANGELOG.md", { plugin = "MyVim" })
end

function M.myvim(when_changed)
  M.open("NEWS.md", { plugin = "MyVim", when_changed = when_changed })
end
