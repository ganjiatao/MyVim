...
function M.format(opts)
  ...
  if not done and opts and opts.force then
    Util.warn("No formatter available", { title = "MyVim" })
  end
end
...
function M.health()
  ...
  local has_extra = vim.tbl_contains(Config.spec.modules, "myvim.plugins.extras.lsp.none-ls")
  if has_plugin and not has_extra then
    Util.warn({
      ...
      "but you need to enable the `myvim.plugins.extras.lsp.none-ls` extra,",
